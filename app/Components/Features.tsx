        ...
        <div className="container px-6 py-10 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="p-8 space-y-3 border-2 border-white rounded-xl">
              ...
              <h1 className="text-xl font-semibold capitalize">Integrated Compiler</h1>
              ...
              <a
                href="#"
                className="inline-flex p-2 text-white transition-colors duration-300 transform bg-white/10 rounded-full hover:underline hover:text-white/80"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 9l3 3m0 0l-3 3m3-3H8m13 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            ...
            <div className="p-8 space-y-3 border-2 border-white rounded-xl">
              ...
              <h1 className="text-xl font-semibold capitalize">Choose your track</h1>
            ...
            <div className="p-8 space-y-3 border-2 border-white rounded-xl">
              ...
              <h1 className="text-xl font-semibold capitalize">Simple & clean designs</h1>

	...
	return (
	  <>
		<section id="FAQ" className="bg-black text-white">
		  <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8 h-150">
			...
			<div className="space-y-4">
			  <details className="w-full border border-white rounded-lg hover:cursor-pointer">
				<summary className="px-4 py-6 focus:outline-none">Ex orci laoreet egestas sapien magna egestas scelerisque?</summary>
			  ...
			  <details className="w-full border border-white rounded-lg hover:cursor-pointer">
				<summary className="px-4 py-6 focus:outline-none">Lorem at arcu rutrum viverra metus sapien venenatis lobortis odio?</summary>
				<p className="px-4 py-6 pt-0 ml-4 -mt-4 text-white">
				  Tincidunt ut hac condimentum rhoncus phasellus nostra. Magna porttitor egestas tincidunt neque vehicula potenti.
				</p>
			  </details>
			  <details className="w-full border border-white rounded-lg hover:cursor-pointer">
				<summary className="px-4 py-6 focus:outline-none">Eleifend feugiat sollicitudin laoreet adipiscing bibendum suscipit erat?</summary>
				<p className="px-4 py-6 pt-0 ml-4 -mt-4 text-white">
